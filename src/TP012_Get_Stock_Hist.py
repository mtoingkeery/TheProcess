...
def main():
    ...
    para_id_list=fdt.get_stock_list()
    ...
    for para in target_list:
        ...
        fdt.get_stock_hist(para_id,para_mon,except_list,label="stock")
    ...
    if len(except_list)>0:
        ...
        for para in except_list:
            ...
            print(except_dep)
            fdt.get_stock_hist(para_id,para_mon,log_list,label="stock")
    ...
    if len(log_list)>0:
        ...
        log_list_file=data_path+"stock_hist_failed_list_"+fda.current_date_str+".txt"
