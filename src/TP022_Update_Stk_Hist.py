...
def main():
    ...
    fdt.pgs_execute_query("TRUNCATE TABLE MAIN.TMP_STK_HIST")

    hist_list=[]
    for parent,dirnames,filenames in os.walk(data_path+"stk_hist/"):
    ...
    fdt.pgs_execute_query("SELECT DW.PGS_UPDATE_HIST_STK('"+para_date_start+"')")
